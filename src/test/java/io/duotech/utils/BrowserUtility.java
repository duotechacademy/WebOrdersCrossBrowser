...
public class BrowserUtility {
	...
	public static WebElement fluentWait(final WebElement webElement, int seconds) {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(Driver.getDriver()).withTimeout(seconds, TimeUnit.SECONDS)
				.pollingEvery(seconds, TimeUnit.SECONDS).ignoring(NoSuchElementException.class);
